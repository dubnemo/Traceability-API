...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class StatusList : List<Status>, IEquatable<StatusList>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((StatusList)obj);
        }

        /// <summary>
        /// Returns true if StatusList instances are equal
        /// </summary>
        /// <param name="other">Instance of StatusList to be compared</param>
        /// <returns>Boolean</returns>
